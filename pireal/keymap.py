...
KEYMAP = {
    'create_database': QKeySequence(Qt.CTRL + Qt.SHIFT + Qt.Key_N),
    'open_database': QKeySequence(Qt.CTRL + Qt.SHIFT + Qt.Key_O),
    'save_database': QKeySequence(Qt.CTRL + Qt.SHIFT + Qt.Key_S),
    'close_database': QKeySequence(Qt.CTRL + Qt.SHIFT + Qt.Key_W),
    'new_query': QKeySequence(Qt.CTRL + Qt.Key_N),
    'open_query': QKeySequence(Qt.CTRL + Qt.Key_O),
    'save_query': QKeySequence(Qt.CTRL + Qt.Key_S),
    'close_query': QKeySequence(Qt.CTRL + Qt.Key_W),
    'show_preferences': QKeySequence(Qt.CTRL + Qt.SHIFT + Qt.Key_P),
    ...
    # 'execute_query': QKeySequence(Qt.CTRL + Qt.Key_R)
}
