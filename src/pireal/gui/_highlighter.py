...
class Highlighter(QSyntaxHighlighter):
    ...
    def __init__(self, editor):
        ...
        var_format.setForeground(QColor("#ff0000"))
        ...
        op_format.setForeground(QColor("#00ff00"))
