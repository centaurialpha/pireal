...
class Pireal(QMainWindow):
    ...
    _instance: Optional["Pireal"] = None

    @classmethod
    def instance(cls) -> Optional["Pireal"]:
    ...
    def __init__(self, check_updates=True):
        ...
        # # Central widget
        self.setCentralWidget(self.get("central"))
    ...
    def register(self, name: str, widget: QObject) -> QObject:
        return self.registry.register(name, widget)
