...
TR_MENU_SCHEME_ADD_RELATIONS_FROM_TEXT = QCoreApplication.translate("Pireal", "Add Relations from Text")
...
TR_ADD_RELATIONS_FROM_TEXT_TITLE = QCoreApplication.translate("Pireal", "Add Relations from Text")
TR_ADD_RELATIONS_FROM_TEXT_EDITOR_LABEL = QCoreApplication.translate("Pireal", "Relations text:")
