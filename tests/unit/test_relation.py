...
def relation_fixture():
    ...
    r2.header = ["id", "skill"]
    data = {("3", "Ruby"), ("1", "Python"), ("12", "Sangre"), ("23", "Games")}
    for d in data:
        r2.insert(d)
...
def test_projection(relation_fixture):
    ...
    expected = {("Gabriel",), ("Rodrigo",), ("Marisel",), ("Diego",)}
...
def test_combination(relation_fixture):
    ...
    expected = {("Gabriel", "Python"), ("Rodrigo", "Games"), ("Marisel", "Sangre")}
...
def test_product(relation_fixture):
    expected = {
        ...
        ("12", "Marisel", "Lavalle", "2015-12-12"),
        ("12", "Marisel", "Lavalle", "2012-07-09"),
        ("12", "Marisel", "Lavalle", "1998-12-09"),
