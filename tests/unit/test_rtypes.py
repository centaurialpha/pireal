...
class RelationTypesTestCase(unittest.TestCase):
    ...
    def test_date(self):
        self.assertEqual(RType.cast('20/01/1991'), datetime.date(year=1991, month=1, day=20))
        self.assertEqual(RType.cast('1991/01/20'), datetime.date(year=1991, month=1, day=20))
